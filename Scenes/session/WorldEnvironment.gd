...
func _process(delta):
	...
	var ambient_red = get_zsf_instant(timer, ambient_red_zsf)	
	var ambient_green = get_zsf_instant(timer, ambient_green_zsf)	
	var ambient_blue = get_zsf_instant(timer, ambient_blue_zsf)	
